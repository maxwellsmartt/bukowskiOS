  ...
  it("creates a project blueprint with a hidden main unit and visible additional units", () => {
    ...
    mutations.createProjectBlueprint({
      ...
      generalInfo: {
        ...
        preproductionStartDate: "2026-07-25",
        preproductionEndDate: "2026-07-30",
        colorKey: "teal",
      ...
      mainUnit: {
        name: "Main Unit",
        windows: [{ startDate: "2026-08-01", endDate: "2026-08-10", sortOrder: 0 }],
        departmentIds: ["dept-video"],
      ...
      additionalUnits: [
        {
          name: "Second Unit",
          code: "BLUE-2U",
          windows: [{ startDate: "2026-08-03", endDate: "2026-08-06", sortOrder: 0 }],
          departmentIds: ["dept-video"],
