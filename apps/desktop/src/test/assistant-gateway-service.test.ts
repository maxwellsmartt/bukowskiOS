        ...
        createResponse: async () => {
          ...
          return {
            ...
            outputText: JSON.stringify({
              ...
              assistant_reply: "Chat is configured.",
        ...
        createResponse: async (_config, input) => {
          ...
          return {
            ...
            outputText: JSON.stringify({
              ...
              requires_approval: false,
              tool_call_requested: false,
              assistant_reply: "Routed to Supervisor Agent. I reviewed the attached image and answered from supervised routing.",
              answer_kind: "informational",
              draft_run_title: null,
              draft_run_description: null,
            }),
          ...
          if (responseCount === 1) {
            return {
              ...
              outputText: JSON.stringify({
                ...
                requires_approval: false,
                tool_call_requested: true,
                assistant_reply: "Routed to Finance Agent to run the operational test.",
                answer_kind: "informational",
                draft_run_title: null,
                draft_run_description: null,
              }),
        ...
        createResponse: async (_config, input) => {
          ...
          return {
            ...
            outputText: JSON.stringify({
              ...
              requires_approval: false,
              tool_call_requested: false,
              assistant_reply: "Supervisor completed the read-only tool chain.",
              answer_kind: "informational",
              draft_run_title: null,
              draft_run_description: null,
            }),
        ...
        createResponse: async () => {
          ...
          if (callCount === 1) {
            return {
              ...
              outputText: JSON.stringify({
                ...
                requires_approval: false,
                tool_call_requested: true,
                assistant_reply: "Routing to Finance Agent.",
                answer_kind: "informational",
                draft_run_title: null,
                draft_run_description: null,
              }),
          ...
          return {
            ...
            outputText: JSON.stringify({
              ...
              requires_approval: false,
              tool_call_requested: false,
              assistant_reply: "I cannot show finance data because your role does not include Finance access.",
              answer_kind: "informational",
              draft_run_title: null,
              draft_run_description: null,
            }),
      ...
      openaiProviderService: {
        createResponse: async () => ({
          ...
          status: "completed",
            ...
            requires_approval: false,
            tool_call_requested: false,
            assistant_reply: "Prepared the incident review draft.",
            answer_kind: "draft_run",
