...
export const AssetAssignMovePanel = ({
  ...
  return (
    ...
    >
      ...
      <div className={`asset-assign-move-layout${mode !== "assign" ? " asset-assign-move-layout-single" : ""}`}>
        <div className="asset-assign-move-form-pane">
        ...
        {mode === "assign" ? (
          <aside className="asset-assign-move-selection-pane">
