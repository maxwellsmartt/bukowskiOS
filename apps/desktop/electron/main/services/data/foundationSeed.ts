...
const permissions = [
  ...
  ["perm-currency-manage-rates", "currency.manage_rates", "Manage exchange rates", "Create and edit currency settings and exchange rates"],
  ...
  ["perm-treasury-accounts-manage", "treasury.accounts.manage", "Manage bank accounts", "Create and edit workspace bank accounts"],
  ["perm-treasury-import", "treasury.import", "Import bank statements", "Import CSV/XLSX/manual bank statement rows"],
  ["perm-treasury-transactions-read", "treasury.transactions.read", "Read treasury", "View bank accounts, transactions and treasury overview"],
  ...
  try {
    ...
    runSeedRows(
      ...
      [
        ...
        ["role-admin", "perm-finance-manage", now],
        ["role-admin", "perm-currency-manage-rates", now],
        ...
        ["role-admin", "perm-treasury-accounts-manage", now],
        ["role-admin", "perm-treasury-import", now],
        ["role-admin", "perm-treasury-transactions-read", now],
        ["role-admin", "perm-treasury-transactions-classify", now],
        ["role-admin", "perm-treasury-reimbursements-review", now],
        ["role-admin", "perm-treasury-export", now],
