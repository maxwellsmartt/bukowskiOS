...
const bukowskiApp = {
  ...
  revealLogFile: (name: string) => ipcRenderer.invoke(ipcChannels.app.revealLogFile, name) as Promise<void>,
  ...
  applyRemoteKits: (input: AppApplyRemoteKitsCommand) =>
    ipcRenderer.invoke(ipcChannels.app.applyRemoteKits, input) as Promise<AppApplyRemoteKitsResult>,
  ...
  applyRemoteFinanceBusinessRows: (input: AppApplyRemoteFinanceBusinessRowsCommand) =>
    ipcRenderer.invoke(ipcChannels.app.applyRemoteFinanceBusinessRows, input) as Promise<
      AppApplyRemoteFinanceBusinessRowsResult
    >,
  applyRemoteAutomationControlPlaneRows: (input: AppApplyRemoteAutomationControlPlaneRowsCommand) =>
    ipcRenderer.invoke(ipcChannels.app.applyRemoteAutomationControlPlaneRows, input) as Promise<
      AppApplyRemoteAutomationControlPlaneRowsResult
    >,
};
...
const bukowskiAuth = {
  ...
  getStoredAvatar: (userId: string) =>
    ipcRenderer.invoke(ipcChannels.auth.getStoredAvatar, userId) as Promise<string | null>,
  cacheAvatar: (input: { userId: string; dataUrl: string }) =>
    ipcRenderer.invoke(ipcChannels.auth.cacheAvatar, input) as Promise<boolean>,
  clearStoredAvatar: (userId: string) =>
    ipcRenderer.invoke(ipcChannels.auth.clearStoredAvatar, userId) as Promise<boolean>,
